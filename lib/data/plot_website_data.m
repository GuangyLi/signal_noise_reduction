...
f=figure(1);
movegui(f,'west');
google3 = dlmread('google3.txt', ' ', 1, 0);
google3(end)=[];
...
google4 = dlmread('google4.txt', ' ', 1, 0);
google4(end)=[];
...
google5 = dlmread('google5.txt', ' ', 1, 0);
google5(end)=[];
...
google6 = dlmread('google6.txt', ' ', 1, 0);
google6(end)=[];
...
google7 = dlmread('google7.txt', ' ', 1, 0);
google7(end)=[];
...
currentFigure = gcf;
t=sgtitle("Current Traces for Loading google.com");
 
%---------------------------------------%
figure(2);

yt1 = dlmread('youtube1.txt', ' ', 1, 0);
yt1(end)=[];
...
currentFigure = gcf;
t=sgtitle("Current Traces for Loading youtube.com");